...
const ChooseService = () => {
  return (
    <div className="font-Poppins bg-[#F8FAFC]">
      <div className="">
        ...
        <div className="p-[10px]">
          <div className="bg-white rounded-[10px] flex flex-col px-5 py-5 lg:p-[50px]">
            ...
            <div className="group-buttons flex justify-end mt-[50px]">
              <div className="">
                <button className="py-[12px] px-[21px] text-primary-color rounded-[28px] border mr-[30px] border-primary-color">
                  Back
                </button>
                <button className="bg-primary-color text-[white] py-[12px] px-[21px] rounded-[28px]">
                  Next
                </button>
              </div>
            </div>
